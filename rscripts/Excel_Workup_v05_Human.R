...
myoutput <- "output/Data_Tables/23_0829_RCCN2_Cortex_Homolog_Analysis_v01.xlsx"
## modify with your batch name
batch <- "RCCN2"
## modify with your search information
search_info <- "homologous protein data from overlap in searches with directDIA against Macaca mulatta and Homo sapiens Reference Proteome"
comparison_info <- "homologous protein comparison"
